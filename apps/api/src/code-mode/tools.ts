...
export const apiTools: ApiToolDefinition[] = [
  ...
  {
    name: 'bizing.knowledge.stats',
    description: 'Return high-level counts for the shared knowledge plane.',
    method: 'GET',
  ...
  {
    name: 'bizing.knowledge.sources.list',
    description: 'List configured knowledge sources used for ingest and synchronization.',
    method: 'GET',
  ...
  {
    name: 'bizing.knowledge.sources.create',
    description: 'Create a knowledge source (for example code docs or mind workspace).',
    method: 'POST',
    path: '/api/v1/knowledge/sources',
    tags: ['knowledge', 'agents'],
    parameters: {
      ...
      required: ['sourceKey', 'displayName'],
    },
  },
  {
    name: 'bizing.knowledge.documents.list',
  ...
  {
    name: 'bizing.knowledge.documents.create',
    description: 'Create one knowledge document and optionally auto-chunk + auto-embed it.',
    method: 'POST',
    path: '/api/v1/knowledge/documents',
    tags: ['knowledge', 'agents'],
    parameters: {
      ...
      properties: {
        ...
        autoEmbed: { type: 'boolean' },
        chunkMaxChars: { type: 'number' },
        chunkOverlapChars: { type: 'number' },
        metadata: { type: 'object' },
      },
      required: ['sourceId', 'documentKey', 'title', 'contentText'],
    },
  },
  {
    name: 'bizing.knowledge.sources.ingestFiles',
    description: 'Scan a source filesystem path and ingest matching files into the shared knowledge plane.',
    method: 'POST',
    path: '/api/v1/knowledge/sources/{sourceId}/ingest-files',
    tags: ['knowledge', 'agents'],
    parameters: {
      type: 'object',
      properties: {
  ...
  {
    name: 'bizing.knowledge.query',
    description: 'Run keyword, semantic, or hybrid retrieval across ingested knowledge.',
    method: 'POST',
    ...
    parameters: {
      ...
      properties: {
        ...
        mode: { type: 'string', enum: ['keyword', 'semantic', 'hybrid', 'graph'] },
        limit: { type: 'number', default: 12 },
        candidateLimit: { type: 'number', default: 2000 },
        agentRunId: { type: 'string' },
        createTrace: { type: 'boolean' },
      },
      required: ['queryText'],
    },
  },
  {
    name: 'bizing.knowledge.checkpoints.list',
    description: 'List checkpoint cursors for codex/openclaw/bizing agents.',
    method: 'GET',
    path: '/api/v1/knowledge/checkpoints',
    tags: ['knowledge', 'agents'],
    parameters: {
      type: 'object',
      properties: {
  ...
  {
    name: 'bizing.knowledge.checkpoints.upsert',
    description: 'Create or update one checkpoint cursor for an agent runtime.',
    method: 'PUT',
    path: '/api/v1/knowledge/checkpoints/{agentKind}/{agentName}',
    tags: ['knowledge', 'agents'],
    parameters: {
      type: 'object',
      properties: {
        ...
        bizId: { type: 'string' },
        checkpointKey: { type: 'string' },
        lastKnowledgeEventId: { type: 'string' },
        lastCommitSha: { type: 'string' },
        lastDocumentHash: { type: 'string' },
        lastIngestedAt: { type: 'string' },
        status: { type: 'string' },
        metadata: { type: 'object' },
      },
      required: ['agentKind', 'agentName'],
    },
  },
  {
    name: 'bizing.knowledge.syncStatus',
    description: 'Compare checkpoint cursors and commit hashes to detect codex/openclaw drift.',
    method: 'GET',
    path: '/api/v1/knowledge/sync-status',
    tags: ['knowledge', 'agents'],
    parameters: {
      type: 'object',
      properties: {
  ...
  {
    name: 'bizing.sagas.specs.reclassifyDepth',
    description: 'Recompute shallow/medium/deep depth classification for all active saga definitions.',
    method: 'POST',
    path: '/api/v1/ooda/sagas/specs/depth/reclassify',
    tags: ['sagas', 'specs', 'depth'],
    parameters: {
      type: 'object',
      properties: {},
    },
