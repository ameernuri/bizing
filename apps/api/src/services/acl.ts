...
const CORE_PERMISSION_SEEDS: PermissionSeed[] = [
  ...
  { key: 'services.read', name: 'Read Services', moduleKey: 'services', description: 'View services and service groups.' },
  { key: 'services.create', name: 'Create Services', moduleKey: 'services', description: 'Create services and service groups.' },
  { key: 'services.update', name: 'Update Services', moduleKey: 'services', description: 'Edit services and service groups.' },
  { key: 'services.archive', name: 'Archive Services', moduleKey: 'services', description: 'Archive services and service groups.' },
  {
    key: 'service_products.read',
    name: 'Read Service Products',
    moduleKey: 'service_products',
    description: 'View service products and linked service bindings.',
  },
  {
    key: 'service_products.create',
    name: 'Create Service Products',
    moduleKey: 'service_products',
    description: 'Create service products.',
  },
  {
    key: 'service_products.update',
    name: 'Update Service Products',
    moduleKey: 'service_products',
    description: 'Edit service products and linked service bindings.',
  },
  {
    key: 'service_products.archive',
    name: 'Archive Service Products',
    moduleKey: 'service_products',
    description: 'Archive service products.',
  },
  { key: 'calendars.read', name: 'Read Calendars', moduleKey: 'calendars', description: 'View calendars and calendar bindings.' },
  { key: 'calendars.write', name: 'Write Calendars', moduleKey: 'calendars', description: 'Create/update calendars and bindings.' },
  {
    key: 'availability_rules.read',
    name: 'Read Availability Rules',
    moduleKey: 'calendars',
    description: 'View availability rules attached to calendars.',
  },
  {
    key: 'availability_rules.write',
    name: 'Write Availability Rules',
    moduleKey: 'calendars',
    description: 'Create/update availability rules attached to calendars.',
  },
  ...
  { key: 'pricing.write', name: 'Write Pricing', moduleKey: 'pricing', description: 'Create/update pricing rules and demand-pricing policies.' },
  {
    ...
    description: 'View outbound messages, consent state, and quiet-hour policies.',
  },
  {
    key: 'communications.write',
    name: 'Write Communications',
    moduleKey: 'communications',
    description: 'Create/update communications policy and consent records.',
  },
  {
    key: 'group_accounts.read',
    name: 'Read Group Accounts',
    moduleKey: 'group_accounts',
    description: 'View shared family/company/group accounts and their members.',
  },
  {
    key: 'group_accounts.write',
    name: 'Write Group Accounts',
    moduleKey: 'group_accounts',
    description: 'Create/update shared family/company/group accounts and their members.',
  },
  {
    key: 'custom_fields.read',
    name: 'Read Custom Fields',
    moduleKey: 'custom_fields',
    description: 'View custom field definitions, options, and resolved values.',
  },
  {
    key: 'custom_fields.write',
    name: 'Write Custom Fields',
    moduleKey: 'custom_fields',
    description: 'Create/update custom field definitions, options, and values.',
  },
  {
    key: 'entitlements.read',
    name: 'Read Entitlements',
    moduleKey: 'entitlements',
    description: 'View membership plans, memberships, wallets, grants, and ledgers.',
  },
  {
    key: 'entitlements.write',
    name: 'Write Entitlements',
    moduleKey: 'entitlements',
    description: 'Create/update membership plans, memberships, wallets, grants, and rollover runs.',
  },
...
const DEFAULT_ROLE_PERMISSION_KEYS: Record<string, string[]> = {
  ...
  manager: [
    ...
    'services.update',
    'services.archive',
    'service_products.read',
    'service_products.create',
    'service_products.update',
    'service_products.archive',
    'calendars.read',
    'calendars.write',
