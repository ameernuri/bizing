      ...
      <main className="lg:ml-64 p-6">
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Entity relationship graph for Bizing. Click on any entity to see columns, relationships, and related endpoints.
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-3xl font-bold text-purple-600">51</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-3xl font-bold text-green-600">12</CardTitle>
            </CardHeader>
            <CardContent>
