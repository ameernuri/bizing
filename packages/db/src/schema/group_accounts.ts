 ...
 *
 * Relationship map:
 * - Referenced by `bookings.group_account_id` for shared/group bookings.
...
export const groupAccounts = pgTable('group_accounts', {
  ...
  /** Company profile payload when `type=company` (license/contact/legal). */
...
/** @deprecated Use `groupAccounts`. */
export const sharedAccounts = groupAccounts
/** @deprecated Use `groupAccountMembers`. */
export const sharedAccountMembers = groupAccountMembers
/** @deprecated Use `GroupAccount`. */
export type SharedAccount = GroupAccount
/** @deprecated Use `NewGroupAccount`. */
export type NewSharedAccount = NewGroupAccount
/** @deprecated Use `GroupAccountMember`. */
export type SharedAccountMember = GroupAccountMember
/** @deprecated Use `NewGroupAccountMember`. */
export type NewSharedAccountMember = NewGroupAccountMember

/** @deprecated Use `groupAccounts`. */
export const parties = groupAccounts
/** @deprecated Use `groupAccountMembers`. */
export const partyMembers = groupAccountMembers

/** @deprecated Use `GroupAccount`. */
export type Party = GroupAccount
/** @deprecated Use `NewGroupAccount`. */
export type NewParty = NewGroupAccount
/** @deprecated Use `GroupAccountMember`. */
export type PartyMember = GroupAccountMember
/** @deprecated Use `NewGroupAccountMember`. */
export type NewPartyMember = NewGroupAccountMember
