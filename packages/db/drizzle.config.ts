...
export default defineConfig({
  ...
  schema: [
    ...
    "./src/schema/enums.ts",
    "./src/schema/action_backbone.ts",
    "./src/schema/domain_events.ts",
    "./src/schema/external_installations.ts",
    "./src/schema/schedule_subjects.ts",
    "./src/schema/coverage_lanes.ts",
    "./src/schema/projections.ts",
    "./src/schema/knowledge.ts",
    "./src/schema/inventory_procurement.ts",
    "./src/schema/value_programs.ts",
    "./src/schema/workforce_core.ts",
    "./src/schema/offers.ts",
    "./src/schema/supply.ts",
    "./src/schema/time_scopes.ts",
    "./src/schema/booking_capacity_claims.ts",
    "./src/schema/capacity_reservations.ts",
    ...
    "./src/schema/compliance_programs.ts",
    "./src/schema/hipaa.ts",
    ...
    "./src/schema/auth_observability.ts",
